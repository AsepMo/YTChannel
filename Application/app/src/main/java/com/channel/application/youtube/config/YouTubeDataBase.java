...
{
    public static String TAG = YouTubeDataBase.class.getSimpleName();
    ...
    public YouTube getYoutube(Context context)
    {
        ...
        {
            // show message
            new YouTube(context).sendShortMessage("Nothing found");
        ...
        while (videoQueryCursor.moveToNext())
        {
            ...
            YouTube youtubeVideo = new YouTube(title, thumbnail , videoId, description, published, true);
    ...
    public ArrayList<YouTube> getLocallyStoredData(Context context)
    {
