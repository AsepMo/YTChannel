...
import com.channel.engine.widget.helper.PreferenceHelper;
...
public abstract class AbstractCameraActivity extends AppCompatActivity implements CameraView {
        ...
        if (!hasPermissionDisbled) {
            ...
            snackBar.show(R.string.imagepicker_msg_no_write_external_storage_camera_permission, new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    PermissionHelper.openAppSettings(AbstractCameraActivity.this);
                }
            });
        }
    }
