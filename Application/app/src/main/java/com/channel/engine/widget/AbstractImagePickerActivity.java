...
import com.channel.engine.widget.helper.CameraHelper;
import com.channel.engine.widget.helper.LogHelper;
import com.channel.engine.widget.helper.PermissionHelper;
import com.channel.engine.widget.listener.OnBackAction;
import com.channel.engine.widget.listener.OnFolderClickListener;
import com.channel.engine.widget.listener.OnImageClickListener;
import com.channel.engine.widget.listener.OnImageSelectionListener;
...
import com.channel.engine.widget.common.RecyclerViewManager;
import com.channel.engine.widget.common.ImagePickerView;
import com.channel.engine.widget.common.ImagePickerPresenter;
import com.channel.engine.widget.common.ImageLoader;
import com.channel.engine.widget.common.ImageFileLoader;
import com.channel.engine.widget.ImagePickerToolbar;
import com.channel.engine.widget.ProgressWheel;
import com.channel.engine.widget.SnackBarView;
 ...
 */
public abstract class AbstractImagePickerActivity extends AppCompatActivity implements ImagePickerView {
    ...
    private void getDataWithPermission() {
        ...
        PermissionHelper.checkPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE, new PermissionHelper.PermissionAskListener() {
            ...
            public void onNeedPermission() {
                PermissionHelper.requestAllPermissions(AbstractImagePickerActivity.this, permissions, Config.RC_WRITE_EXTERNAL_STORAGE_PERMISSION);
            }
            ...
            public void onPermissionDisabled() {
                snackBar.show(R.string.imagepicker_msg_no_write_external_storage_permission, new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        PermissionHelper.openAppSettings(AbstractImagePickerActivity.this);
                    }
                });
            }
    ...
    private void captureImageWithPermission() {
        ...
        PermissionHelper.checkPermission(this, Manifest.permission.CAMERA, new PermissionHelper.PermissionAskListener() {
            @Override
            public void onNeedPermission() {
                PermissionHelper.requestAllPermissions(AbstractImagePickerActivity.this, permissions, Config.RC_CAMERA_PERMISSION);
            }
        ...
        switch (requestCode) {
            case Config.RC_WRITE_EXTERNAL_STORAGE_PERMISSION: {
                ...
                logger.e("Permission not granted: results len = " + grantResults.length +
                        " Result code = " + (grantResults.length > 0 ? grantResults[0] : 0));
                finish();
            }
